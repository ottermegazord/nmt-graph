...
*                 from English to Cypher - Model Functions
*
...
class Encoder(tf.keras.Model):
    """
    Encoder for Neural Machine Translation
    """
    def __init__(self, vocab_size, embedding_dim, enc_units, batch_sz):
        ...
        :param enc_units: Dimensionality of output space
...
class BahdanauAttention(tf.keras.Model):
    """
    Bahdanau Attention Class Implementation
    """
    def __init__(self, units):
        """
        Initialize class
        :param units: No of units to dense into
        """
    ...
    def call(self, query, values):
        """
        Call Bahdanuau Attention function
        :param query:
        :param values:
